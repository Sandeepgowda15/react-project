...
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 089783390772.dkr.ecr.us-east-1.amazonaws.com

echo "Pulling latest React image..."
